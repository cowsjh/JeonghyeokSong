...
- **`index.html`** — Landing page with hero section, 3-column gallery grid, and contact links.
...
1. Create `works/<slug>.md` with YAML frontmatter:
   ...
   ```
2. Add a gallery card in `index.html` linking to `work.html?id=<slug>`.
...
- `≤ 960px`: 2-column gallery
- `≤ 640px`: 1-column gallery
